...
1. Defina, com o time, o **nível de conformidade alvo** (ex.: WCAG 2.2 AA).
2. Use o checklist de **Gestão do Projeto** para:
...
1. Para cada nova tela, use o checklist de **Design**:
   - verifique contraste de cores;
   - tamanho de fonte;
   - hierarquia de títulos;
   - foco visível;
   - alvos de toque (especialmente em mobile).
2. Ajuste o design **antes** de enviar para desenvolvimento.
...
1. Use o checklist de **Desenvolvimento Web / Mobile** para:
...
2. Na revisão de código (PR), verifique se os itens críticos estão marcados como **“atendidos”**.
...
1. Use o checklist de **Conteúdo** para:
...
2. Sempre que um novo conteúdo for criado ou atualizado, revise pelos itens do checklist.
...
1. Execute as ferramentas listadas em **Ferramentas de Apoio**:
...
3. Atualize os checklists marcando o que foi corrigido.
...
- Repita este fluxo sempre que:
  - novas funcionalidades forem criadas;
  - o layout for reformulado;
  - houver atualização de normas ou critérios.
